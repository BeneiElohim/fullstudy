...
import { AddIcon } from '@chakra-ui/icons';
  ...
  function AddExam({ subjects, ...props }) {
    ...
    const validateForm = () => {
      ...
      if (!examDate) newErrors.dueDate = 'Exam date is required';
    ...
    const handleSubmit = async (e) => {
      ...
      const formattedExamDate = examDate.replace('T', ' ') + ':00';
      ...
      try {
        const response = await fetch('http://localhost:3001/exams/new-exam', {
          method: 'POST',
          ...
          <ModalContent>
            ...
            <ModalBody as="form" onSubmit={handleSubmit}>
              <FormControl isInvalid={errors.title}>
                ...
                <Input placeholder='Add the exam name here...' value={title} onChange={e => setTitle(e.target.value)} />
